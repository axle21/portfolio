    ...
    <div className='w-11/12 max-w-3xl text-center mx-auto  h-screen flex flex-col items-center justify-center gap-4'>
      <motion.div
        ...
        <Image
          ...
          alt='Logo'
          className='w-32 h-32 rounded-full bg-[#E4E0DD] object-cover'
        />
      </motion.div>
      <motion.h3
        ...
        Hi I'm Axle <Image src={assets.hand_icon} alt='Logo' className='w-6' />
      </motion.h3>
      ...
      <motion.h1
        ...
        Front-end web developer based in Manila
      </motion.h1>
      <motion.p
        initial={{ opacity: 0 }}
